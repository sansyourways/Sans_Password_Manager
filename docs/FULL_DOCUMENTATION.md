...
Every web capture below was taken from the 4.2.1 release candidate in Chromium
...
```bash
gh attestation verify Sans_Password_Manager_v4.2.1.zip \
...
git checkout v4.2.1
./release-archive.sh
sha256sum -c Sans_Password_Manager_v4.2.1.zip.sha256
```
...
```bash
brew install --formula   "https://github.com/sansyourways/Sans_Password_Manager/releases/download/v4.2.1/spm.rb"
```
...
```text
Installed SPM 4.2.1 at /home/you/.local/bin/spm
