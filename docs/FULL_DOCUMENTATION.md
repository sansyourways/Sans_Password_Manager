...
```bash
gh attestation verify Sans_Password_Manager_v5.0.2.zip \
...
git checkout v5.0.2
./release-archive.sh
sha256sum -c Sans_Password_Manager_v5.0.2.zip.sha256
```
...
```bash
brew install --formula   "https://github.com/sansyourways/Sans_Password_Manager/releases/download/v5.0.2/spm.rb"
```
...
```text
Installed SPM 5.0.2 at /home/you/.local/bin/spm
